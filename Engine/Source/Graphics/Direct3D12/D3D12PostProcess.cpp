...
namespace primal::graphics::d3d12::fx {
	...
	namespace {
		...
		bool create_fx_pso_and_root_signature()
		{
			...
			assert(fx_root_sig);
			NAME_D3D12_OBJECT(fx_root_sig, L"Post Process Root Signature");
	...
	void post_process(id3d12_graphic_command_list* cmd_list, D3D12_CPU_DESCRIPTOR_HANDLE target_rtv)
	{
