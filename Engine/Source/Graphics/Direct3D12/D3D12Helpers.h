...
namespace primal::graphics::d3d12::d3dx {
	...
	public:
		...
		void apply(id3d12_graphic_command_list* cmd_list)
		{
			assert(_offset);
	...
	void transition_resource(
		id3d12_graphic_command_list* cmd_list, 
		ID3D12Resource* resource,
		D3D12_RESOURCE_STATES before,
		D3D12_RESOURCE_STATES after,
		D3D12_RESOURCE_BARRIER_FLAGS flags = D3D12_RESOURCE_BARRIER_FLAG_NONE,
	...
	ID3D12RootSignature* create_root_signature(const struct d3d12_root_signature_desc& desc);
	...
	PSS(depth_stencil2, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_DEPTH_STENCIL2, D3D12_DEPTH_STENCIL_DESC2);
	PSS(rasterizer1, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_RASTERIZER1, D3D12_RASTERIZER_DESC1);
	PSS(rasterizer2, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_RASTERIZER2, D3D12_RASTERIZER_DESC2);
	...
	struct d3d12_pipeline_state_subobject_stream {
		...
		d3d12_pipeline_state_subobject_depth_stencil		 		depth_stencil{};
		...
		d3d12_pipeline_state_subobject_depth_stencil2		 		depth_stencil2{};
		d3d12_pipeline_state_subobject_rasterizer1			 		rasterizer1{};
		d3d12_pipeline_state_subobject_rasterizer2			 		rasterizer2{};
	};
