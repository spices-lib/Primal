...
namespace {
	...
	{
		{ "FullScreenTriangle.hlsl", "FullScreenTriangleVS", engine_shader::full_screen_triangle_vs, shader_type::vertex },
	...
	constexpr const char* shaders_source_path{ "../Engine/Source/Graphics/Direct3D12/Shaders/" };
